...
- Set the Github repo("csc413-tankgame-diyorazee") as the content root
...
we can run the game by simply double clicking jar file("csc413-tankgame-diyorazee.jar") found in the /jar folder.
